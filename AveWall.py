...
#2. Black не генерировать, а сразу писать напрямую в папку винды (опционально)
#3. При выборе файлов только нужные разрешения — дефолтные обои, процессы, обои у процессов
